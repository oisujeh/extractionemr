...
import org.openmrs.module.extractionemr.api.dao.ExtractionPatientDAO;
...
@Transactional
public class ExtractionPatientServiceImpl extends PatientServiceImpl implements ExtractionPatientService {
	
	private ExtractionPatientDAO dao;
	
	public void setDao(ExtractionPatientDAO dao) {
		this.dao = dao;
	}
