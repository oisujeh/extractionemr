...
import org.openmrs.module.extractionemr.api.dao.ExtractionObsDAO;
...
@Transactional
public class ExtractionObsServiceImpl extends ObsServiceImpl implements ExtractionObsService {
	
	private ExtractionObsDAO dao;
	
	public void setDao(ExtractionObsDAO dao) {
		this.dao = dao;
	}
	...
	public Obs getLastObsByConceptId(Person person, Concept concept, Date from, Date to, boolean includeVoided)
		...
		try {
			...
			LoggerUtils.write(ExtractionObsServiceImpl.class.getName(), e.getMessage(), LoggerUtils.LogFormat.INFO,
	...
	public Obs getFirstObsByConceptId(Person person, Concept concept, Date from, Date to, boolean includeVoided)
		...
		try {
			...
			LoggerUtils.write(ExtractionObsServiceImpl.class.getName(), e.getMessage(), LoggerUtils.LogFormat.FATAL,
			    LoggerUtils.LogLevel.live);
		}
		return obs;
	}
