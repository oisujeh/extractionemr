...
import org.openmrs.module.extractionemr.ndrUtils.Validator;
...
public class NDRUtils {
	...
	public static Marshaller createMarshaller(JAXBContext jaxbContext, boolean skipError) throws JAXBException, SAXException {
		...
		java.net.URL xsdFilePath = Thread.currentThread().getContextClassLoader().getResource("NDR_FP_1.xsd");
